function [Fv] = getGLCMFeatures(glcm)
% 
% Features computed 
% Autocorrelation: [2]   
...
Fv = [Fv;
    out.autoCorrelation,out.clusterProminence,out.clusterShade,out.contrast,...
    out.correlation, out.differenceEntropy,out.differenceVariance,...
    out.dissimilarity,out.energy,out.entropy,out.homogeneity, ...
    out.informationMeasureOfCorrelation1,out.inverseDifference,out.sumEntropy];
